...
const products = [
  ...
  // ── Biologicals ───────────────────────────────────────
  {
    ...
    tabKey: "Biologicals",
    name: "LGT-6",
    spec: "Liraglutide · 6mg/ml",
    desc: "GLP-1 receptor agonist for type 2 diabetes management and obesity. Promotes insulin secretion and reduces appetite.",
    color: "#6A1B9A",
    image: "/brand/lgt6.png",
  },
  {
    cat: "Biologicals",
    tabKey: "Biologicals",
    name: "INS-REGULAR",
    spec: "Insulin Regular · 100 IU/ml",
    desc: "Short-acting human insulin for mealtime blood glucose control in type 1 and type 2 diabetes mellitus.",
    color: "#6A1B9A",
    image: "/brand/ins-regular.png",
  },
  {
    cat: "Biologicals",
    tabKey: "Biologicals",
    name: "INS-NPH",
    spec: "Insulin NPH · 100 IU/ml",
    desc: "Intermediate-acting insulin for basal glucose control. Provides overnight and between-meal coverage.",
    color: "#6A1B9A",
    image: "/brand/ins-nph.png",
  },
  {
    cat: "Biologicals",
    tabKey: "Biologicals",
    name: "INS-PREMIX",
    spec: "Insulin Premix 30/70 · 100 IU/ml",
    desc: "Pre-mixed insulin combining short and intermediate action for simplified twice-daily dosing regimens.",
    color: "#6A1B9A",
    image: "/brand/ins-premix.png",
  },
  {
    cat: "Biologicals",
    tabKey: "Biologicals",
    name: "INS-G",
    spec: "Insulin Glargine · 100 IU/ml",
    desc: "Long-acting basal insulin analogue providing consistent 24-hour glucose control with a flat action profile.",
    color: "#6A1B9A",
    image: "/brand/ins-glargine.png",
  },
  ...
  },
  {
    ...
    tabKey: "Cephalosporins",
    name: "ZORA 500mg / 1gm",
    spec: "Ceftriaxone Injection · 500mg / 1gm Vial",
  ...
  },
  {
    ...
    tabKey: "Cephalosporins",
    name: "KEFBACTUM 1.5",
    spec: "Ceftriaxone + Sulbactam Injection · 1.5gm Vial",
